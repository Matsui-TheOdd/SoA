...
const PrecheckBCFWrapper = () => {
  ...
  document.title = "BCF Collaboration";
  ...
  return (
    <>
      ...
      <SideNav
        ...
        toggleSideNav={toggleSideNav}
      />
      <PrecheckBCF projectId={projectId} />
    </>
  );
};

export default PrecheckBCFWrapper;
