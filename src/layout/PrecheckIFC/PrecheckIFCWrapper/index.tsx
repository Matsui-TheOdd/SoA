...
const PrecheckIFCWrapper = () => {
  ...
  document.title = "View Results Page";
  ...
  return (
    <>
      ...
      <SideNav
        ...
        toggleSideNav={toggleSideNav}
      />
      <PrecheckIFC userId={user.id} projectId={projectId} />
    </>
  );
};

export default PrecheckIFCWrapper;
